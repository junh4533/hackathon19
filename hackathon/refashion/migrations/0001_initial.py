# Generated by Django 2.2.6 on 2019-10-20 00:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('retailer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='refashion.Retailer')),
            ],
        ),
        migrations.CreateModel(
            name='Redemption',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('combined_weight', models.PositiveSmallIntegerField(default=0)),
                ('points_added', models.PositiveSmallIntegerField(default=0)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer_number', models.PositiveSmallIntegerField(default=18205)),
                ('points_balance', models.PositiveSmallIntegerField(default=0)),
                ('address', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='refashion.Address')),
